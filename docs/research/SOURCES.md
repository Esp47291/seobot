...
| Дата | Тема | URL | Что взяли для Job Inside |
|---|---|---|---|
| 2026-08-24 | Telegram bot UX: скорость ответа, меню, выход, честный scope | https://blog.bothero.ai/telegram-bot-best-practice-the-11-rules-that-separate-bots-people-actually-use-from-the-ones-they-block-after-30-seconds | /start = 1 цель + 2–4 кнопки; каждый экран с выходом; unknown input → ближайшее действие, не «не понял»; unprompted ≤ 1–2/день |
| 2026-08-24 | Онбординг-меню и сегментация за 30–60 сек | https://telega.to/blog/telegram-bot-onboarding-flow-2026-menu-based-start-sequence | Сразу ветка исполнитель / заказчик / помощь; один квалифаер (город); value drop (первое задание или «как работаем») |
