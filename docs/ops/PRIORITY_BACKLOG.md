...
| SALES-01 | 15 касаний ICP «локальная услуга» | P1 | next-hour | проверка оффера |
...
| WEB-02 | Домен + UTM + приём `biz_lead` в таблицу/менеджеру | P1 | queued | иначе форма в никуда |
...
- H3: лендинг 1 CTA, форма 3 поля, IA без кабинета, копипаст секций

## Ротация часов

H1 Product/UX  
H2 Analytics events  
H3 Website landing ← **этот run**  
H4 Sales scripts ← **следующий**  
H5 Unit economics  
H6 Acquisition  
H7 Copy system  
H8 Risks&ops  

Углублять, не переписывать скелет. H4: не плодить 11-й «просто ещё скрипт» — усилить qualifiers брифа и стык со страницей `#lead`.
